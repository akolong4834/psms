...
class stock{
    ...
    function create(){
        ...
        $query = "INSERT INTO
                    " . $this->table_name . "
                SET
                    supplier_name=:supplier_name, phone=:phone, created, vehicle_no=:vehicle_no, stock_amount=:stock_amount, station_name=:station_name, pump_id=:pump_id ";
        ...
        $this->vehicle_no=htmlspecialchars(strip_tags($this->vehicle_no));
		$this->stock_amount=htmlspecialchars(strip_tags($this->stock_amount));
        ...
        $stmt->bindParam(":vehicle_no", $this->vehicle_no);
		 $stmt->bindParam(":stock_amount", $this->stock_amount);
