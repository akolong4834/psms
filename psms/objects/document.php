 ...
 public $image;
    ...
    function create(){
        ...
        $query = "INSERT INTO
                    " . $this->table_name . "
                SET
                    document_name=:document_name,  image=:image, created=:created";
    ...
    $query = "SELECT
                document_id, document_name, image,created
            FROM
                " . $this->table_name . "
            ORDER BY
                document_name ASC
...
public function countAll(){
    ...
    $query = "SELECT document_id FROM " . $this->table_name . "";
...
$allowed_file_types=array("jpg", "jpeg", "png",  "pdf", "gif");
